...
<style>
    /* --- STRUKTUR UTAMA --- */
    /* Container utama relatif agar elemen absolute di dalamnya ikut frame */
    .detail-container {
        position: relative;
        width: 100%;
        min-height: 100vh;
    ...
    /* --- LAYER 2: NAVIGASI & INFO (Floating di atas gambar) --- */
    .header-layer {
        position: absolute;
        top: 0; left: 0; right: 0;
        z-index: 10;
        padding: 40px 24px 0;
        height: 380px; /* Samakan dengan hero agar info bisa ditaruh di bawah */
        pointer-events: none; /* Agar klik tembus ke konten jika perlu */
    }
    ...
    /* Info Instansi di tengah gambar */
    .hero-info {
    ...
    .content-layer {
        position: relative;
        z-index: 20;
        margin-top: 320px; /* Jarak dari atas agar gambar terlihat */
        background: #F8FAFC;
        border-radius: 30px 30px 0 0;
        min-height: 60vh;
        padding: 30px 24px 120px; /* Padding bawah utk navbar */
    ...
    .stat-icon { width: 40px; height: 40px; margin-bottom: 8px; object-fit: contain; }
    .stat-val { font-size: 12px; font-weight: 800; color: #3577E5; margin-top: 4px; }
...
{{-- CONTAINER UTAMA (Relatif terhadap Frame HP) --}}
<div class="detail-container">
    ...
    {{-- LAYER 3: CONTENT SCROLL (White Sheet) --}}
    <div class="content-layer">
        ...
        <div id="detail" class="tab-panel">
            <div class="stat-row">
                <div class="stat-card">
                    <img src="https://cdn-icons-png.flaticon.com/512/60/60484.png" class="stat-icon">
                    <div style="font-size:11px;color:#64748B">Biaya</div>
                    <div class="stat-val">Rp {{ number_format($instansi->biaya_pendaftaran, 0, ',', '.') }}</div>
                </div>
                <div class="stat-card">
                    <img src="https://cdn-icons-png.flaticon.com/512/2088/2088617.png" class="stat-icon">
                    <div style="font-size:11px;color:#64748B">Jam Ops</div>
                    <div class="stat-val" style="font-size:10px">{{ $instansi->jam_operasional }}</div>
                </div>
            </div>
            ...
            <a href="tel:{{ $instansi->user->no_hp ?? '' }}" style="text-decoration:none; color:inherit;">
                <div class="contact-row">
                    <div style="display:flex;align-items:center">
                        ...
                        <div class="c-info">
                            <div>Telepon</div>
                            <div style="color:#64748B">{{ $instansi->user->no_hp ?? '-' }}</div>
                        </div>
                    </div>
            ...
            <a href="mailto:{{ $instansi->email }}" style="text-decoration:none; color:inherit;">
                <div class="contact-row">
                    <div style="display:flex;align-items:center">
                        ...
                        <div class="c-info">
                            <div>Email</div>
                            <div style="color:#64748B">{{ $instansi->email }}</div>
                        </div>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="color:#ccc; font-size:12px;"></i>
                </div>
